import style from './Sidebar1.module.css'
            ...
            <aside className={style.sidebar}>
                <div className={style.sidebarTop}>
                    <div className={style.header}>
                        ...
                        <span className={style.name}>Lorem</span>
                    </div>
                    <form className={style.searchBox}>
                        <span className={style.icon}>
                            ...
                            >
                                ...
                                />
                                <path
                                    d="M18.6875 18.4375L14.9719 14.7219"
                                    stroke="white"
                                    strokeWidth="2"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                    ...
                    <menu className={style.sideNav}>
                        <li className={style.sideNavItem}>
                            <div href="" className={style.sideNavLink}>
                                <span className={style.icon}>
                                    <svg
                                        width="18"
                                        height="20"
                        ...
                        <li className={style.sideNavItem}>
                            <div href="" className={style.sideNavLink}>
                                ...
                                <span className={style.text}>Projects</span>
                            </div>
                        </li>
                        <li className={style.sideNavItem}>
                            <div href="" className={style.sideNavLink}>
                                ...
                                <span className={style.text}>Tasks</span>
                            </div>
                        </li>
                        <li className={style.sideNavItem}>
                            <div href="" className={style.sideNavLink}>
                                ...
                                <span className={style.text}>Reporting</span>
                            </div>
                        </li>
                    </menu>
                </div>
                <div className={style.sidebarBottom}>
                    <figure className={style.profile}>
                        ...
                        />
                        <figcaption className={style.profileDetails}>
                            <span className={style.userName}>Lorem, ipsum.</span>
                            <span className={style.userEmail}>lorem@ipsum.com</span>
                        </figcaption>
                    </figure>
                </div>
            </aside>
